...
export const isVerticalSnap = runtime.isVerticalSnap;
export const toCanonicalDelta = runtime.toCanonicalDelta;
export const toCanonicalPos = runtime.toCanonicalPos;
export const toCanonicalVel = runtime.toCanonicalVel;
export const toCanonicalAction = runtime.toCanonicalAction;
export const fromCanonicalAction = runtime.fromCanonicalAction;
